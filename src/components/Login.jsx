  ...
  return (
    <div>
        {form && sign==='login' && <div className='text-white h-[100vh] flex justify-center items-center bg-cover mt-20'
            style={{ backgroundImage: `url(${form==='User'?img1:form==='Mechanic'?img2:form==='Car Wash Servicer'?img3:''})`, backgroundPosition: 'center' }}>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-1 md:grid-cols-3 mx-80 pb-80 pt-80 gap-1'>
            {data.map((item)=>(
